...
class IDeleteResponsePaginated(IResponsePage[DataType], Generic[DataType]):
    message: str | None = "Data delete correctly"
...
class ICreateResponseBase(IResponseBase[DataType], Generic[DataType]):
